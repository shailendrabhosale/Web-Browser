...
//------------------------------------------------------------------------
----------------------------
private ArrayList<c2w_BrowserWindow> c2w_openWindows; // list of
currently open web browser windows
private Rectangle2D c2w_screenRect; // usable area of
the primary screen
private double c2w_locationX, c2w_locationY; // location for
next window to be opened
private double c2w_windowWidth, c2w_windowHeight; // window size,
computed from c2w_screenRect
private int c2w_untitledCount; // how many
"Untitled" window titles have been used
...
// (c2w_locationX,c2w_locationY) will be the location of the

upper left

// corner of the next window to be opened. For the first
...
// The window size depends on the height and width of the
...
// Open the first window, showing the front page of this
...
c2w_openWindows.add(window); // Add new window to open window
...
// Program ends automatically when all windows have been

closed.

System.out.println("Program will end because all windows
...
window.setX(c2w_locationX); // set location and size of
